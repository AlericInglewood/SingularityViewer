...
class CurlEasyRequest : public CurlEasyHandle {
  ...
  private:
	...
	CurlEasyHandleEvents* mEventsTarget;
	CURLcode mResult;
  ...
  public:
	...
	void send_events_to(CurlEasyHandleEvents* target) { mEventsTarget = target; }
...
class ThreadSafeCurlEasyRequest : public AIThreadSafeSimple<CurlEasyRequest> {
  public:
	ThreadSafeCurlEasyRequest(void) throw(AICurlNoEasyHandle) : mReferenceCount(0)
